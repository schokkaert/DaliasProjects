...
$pageTitle = 'Voorwaarden — Dalia Projects';
$pageDescription = 'Voorwaarden van Dalia Projects.';
$activeNav = 'legal';
$bodyPage = 'legal';
    ...
    <main class="site-main">
      ...
      <section class="section">
        <div class="container text-grid">
          ...
          <article class="text-card"><h2>Aansprakelijkheid</h2><p>Dalia Projects kan niet aansprakelijk worden gesteld voor onvolledigheden of tijdelijke technische fouten op de website.</p></article>
        </div>
      </section>
    </main>
