...
<section class="admin-settings-layout">
  <aside class="admin-settings-menu" aria-label="Instellingen menu">
    ...
    <div class="admin-settings-menu__group">
      <p class="admin-settings-menu__title">Site-inhoud & contact</p>
      <a href="#site-inhoud">Overzicht inhoud</a>
    ...
    <div class="admin-settings-menu__group">
      <p class="admin-settings-menu__title">Andere modules</p>
  ...
  <article class="admin-card admin-settings-panel">
    ...
    <h2>Layout, inhoud, contact en mailafzender</h2>
    <form method="post" class="admin-form admin-form--single" data-floating-submit>
      ...
      <section id="layout-weergave" class="admin-settings-group admin-settings-group--layout admin-settings-section">
        <div class="admin-settings-group__intro">
          <p class="admin-settings-group__eyebrow">Layout & weergave</p>
      ...
      <section id="site-inhoud" class="admin-settings-group admin-settings-group--content admin-settings-section">
        <div class="admin-settings-group__intro">
          <p class="admin-settings-group__eyebrow">Site-inhoud & contact</p>
          <h3>Gegevens die bezoekers lezen</h3>
          <p>Hier beheer je de inhoudelijke gegevens van de site: contactinformatie, kaartlinks, sociale kanalen en e-mailadressen die inhoudelijk bij de website horen.</p>
        </div>
